...
type EventServiceClient interface {
	...
	GetEvent(ctx context.Context, in *GetEventByIDRequest, opts ...grpc.CallOption) (*GetEventByIDResponse, error)
}
...
func (c *eventServiceClient) GetEvent(ctx context.Context, in *GetEventByIDRequest, opts ...grpc.CallOption) (*GetEventByIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedEventServiceServer) GetEvent(context.Context, *GetEventByIDRequest) (*GetEventByIDResponse, error) {
...
func _EventService_GetEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).GetEvent(ctx, req.(*GetEventByIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protobuf/events.proto",
}
