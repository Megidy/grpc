...
type PlayerServiceClient interface {
	GetPlayer(ctx context.Context, in *GetPlayerByIDRequest, opts ...grpc.CallOption) (*GetPlayerByIDResponse, error)
}
...
func (c *playerServiceClient) GetPlayer(ctx context.Context, in *GetPlayerByIDRequest, opts ...grpc.CallOption) (*GetPlayerByIDResponse, error) {
...
type PlayerServiceServer interface {
	GetPlayer(context.Context, *GetPlayerByIDRequest) (*GetPlayerByIDResponse, error)
...
func (UnimplementedPlayerServiceServer) GetPlayer(context.Context, *GetPlayerByIDRequest) (*GetPlayerByIDResponse, error) {
...
func _PlayerService_GetPlayer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlayerServiceServer).GetPlayer(ctx, req.(*GetPlayerByIDRequest))
	}
...
var PlayerService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protobuf/players.proto",
}
